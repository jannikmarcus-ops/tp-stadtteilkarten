...
const NEIGHBOR_LABELS = [
  ...
  { id: 'nordfriesland', x: 388, y: 50.1, text: "Kreis Nordfriesland", rotate: 0 },
]

const WATER_LABELS = [
  { x: 22.6, y: 834.6, text: "Nordsee", size: 13 },
  { x: 178, y: 1161.2, text: "Elbe", size: 12 },
  { x: 261.7, y: 161, text: "Eider", size: 11 },
]
...
const LABELS = [
  ...
  { id: 'burg-in-dithmarschen', x: 565.3, y: 838.9, lines: ["Burg"], size: 11 },
